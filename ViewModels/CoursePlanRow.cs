...
{
    public sealed class CoursePlanRow : INotifyPropertyChanged
    {
        ...
        public int? SectionIndex
        {
            ...
            set
            {
                if (_sectionIndex == value) return;
                _sectionIndex = value;
                OnPropertyChanged(nameof(SectionIndex));
                OnPropertyChanged(nameof(IsSectionOverride));
                OnPropertyChanged(nameof(DisplaySectionNumber));
            }
        }

        public bool IsSectionOverride => SectionIndex.HasValue;

        public int DisplaySectionNumber => SectionIndex ?? 1;
